    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                script {
                    dir('terraform') {
                        git url: 'https://github.com/Bhushan-88/Infrastructure.git', branch: 'main'
                    }
                }
            }
        }
        ...
        stage('Plan: 0-bootstrap') {
            ...
            steps {
                ...
                sh 'cd terraform/0-bootstrap && terraform import aws_s3_bucket.tf_state target-corporate-services || true'
